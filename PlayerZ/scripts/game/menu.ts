...
ENGINE_MUST.init(async () => {
    ...
    await (ENGINE_MUST.EVENT_HANDLER.addEventListener as any)("COMMAND_M_START", async () => {
    ...
    await (ENGINE_MUST.EVENT_HANDLER.addEventListener as any)("COMMAND_M_LOAD", async () => {
    ...
    await (ENGINE_MUST.EVENT_HANDLER.addEventListener as any)("COMMAND_M_SETTING", async () => {
